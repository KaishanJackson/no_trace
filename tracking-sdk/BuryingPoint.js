...
//通过xpath锁定Dom的节点
BuryingPoint.prototype.searchDom = function (xpath) {
  var result = document.evaluate(xpath, document, null, XPathResult.ANY_TYPE, null);
  return result.iterateNext();
};
//监听dom节点的变化
BuryingPoint.prototype.listenDomChange = function (changeDom) {
  var _this = this;
  changeDom.addEventListener('DOMNodeInserted', function (e) {
    var eventMap = {
      event: 'select',
...
//通过返回的加签数据，对应节点添加监听
BuryingPoint.prototype.addDomListener = function (list) {
  var _this = this;
...
//先获取加签数据，根据加签数据筛选埋点
BuryingPoint.prototype.getSurePushList = function () {
  var _this2 = this;
...
//处理参数
BuryingPoint.prototype.setEvent = function () {
  this.setEveryEvent.apply(this, arguments);
};
//改写传入的函数，加入埋点方法
BuryingPoint.prototype.setEventListener = function (e) {
  var myFunc = e;
...
//获取Xpath
BuryingPoint.prototype.getDomXPath = function (element) {
...
//xhr请求埋点
BuryingPoint.prototype.xhrBurying = function () {
  var _this = this;
...
//函数埋点接口
BuryingPoint.prototype.subFunction = function (funcArg, funcBody, funcName) {
  var _this = this;
  var functionMap = {
    event: funcName,
    time: new Date().getTime(),
...
//事件埋点
BuryingPoint.prototype.subBurying = function (event) {
  var _this = this;
...
//参数遍历
BuryingPoint.prototype.setEveryEvent = function () {
  var _this = this;
